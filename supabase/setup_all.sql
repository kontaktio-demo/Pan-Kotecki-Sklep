...
-- ===== 6. KONTA KLIENTÓW (passwordless, Supabase Auth) =====
-- Gość jest domyślny; konto to DODATEK. Pełna wersja w supabase/accounts.sql.
...
-- create_order z user_id (gość = NULL). Pełna podmiana funkcji.
create or replace function create_order(p jsonb)
returns jsonb
language plpgsql
set search_path = public, pg_temp
